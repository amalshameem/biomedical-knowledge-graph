import pytest
from app.services.normalizer_service import normalize_entities_non_llm, clean_morphology
...
def test_gliner_ner_extraction():
    from app.services.ner_service import extract_entities_from_text, get_best_ner_type, get_taxonomy_for_type
    ...
    ner_type = get_best_ner_type("TNF-alpha", entities)
    assert ner_type in ["Gene or Gene Product", "Protein", "Chemical"]
